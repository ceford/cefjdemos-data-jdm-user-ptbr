...
![formulário de menu de logout restrito para acesso registrado](../../../en/images/users/login-and-logout-redirects/01-login-redirects-login-form.png)
...
![formulário de logout restrito a acesso registrado](../../../en/images/users/login-and-logout-redirects/02-login-redirects-login-menu-options.png)
...
![formulário de menu de logout restrito ao acesso registrado](../../../en/images/users/login-and-logout-redirects/03-login-redirects-logout-menu-options.png)
