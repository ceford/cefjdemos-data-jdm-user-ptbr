...
![Configurações do plugin CodeMirror](../../../en/images/editors/codemirror-plugin/01-codemirror-plugin-tab.png)

A captura de tela a seguir mostra o realce de cor em HTML e o *Conteúdo do CMS* implementado como uma linha de botões:

![CodeMirror em uso](../../../en/images/editors/codemirror-plugin/02-codemirror-example.png)
