...
![Entrada de dados do módulo de exibição de feed](../../../en/images/news-feeds/news-display/01-news-joomla-news-form.png)

O resultado pode não ser esteticamente agradável, mas pode ser melhorado com alguns estilos personalizados em user.css:

![Entrada de dados do módulo de exibição de feed](../../../en/images/news-feeds/news-display/02-news-joomla-news-display.png)
...
![Entrada de dados do componente NewsFeed](../../../en/images/news-feeds/news-display/03-news-feed-data-entry.png)
...
![Entrada de dados do item de menu NewsFeed](../../../en/images/news-feeds/news-display/04-news-feed-menu-form.png)

Teste: vá ao menu do Site e selecione o item de menu do Feed.

![Exibição do NewsFeed](../../../en/images/news-feeds/news-display/05-news-feed-display.png)
...
![Exibição personalizada do NewsFeed](../../../en/images/news-feeds/news-display/06-news-feed-custom-display.png)
...
![Formulário de menu de feed de notícias por categoria](../../../en/images/news-feeds/news-display/07-news-feed-menu-category-form.png)
