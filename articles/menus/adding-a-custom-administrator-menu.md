<!--
{
  ...
  "title": "Menu Personalizado do Administrador",
  "description": "", 
  "author": ""
}
-->
...
![resultado do menu personalizado do administrador](../../../en/images/menus/adding-a-custom-administrator-menu/02-menus-custom-administrator-menu-result.png)
